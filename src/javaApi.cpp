...
extern "C" DLLEXPORT void JNICALL
Java_one_profiler_AsyncProfiler_setTracingContext0(JNIEnv* env, jobject unused, jlong spanId, jlong spanName) {
    Profiler::instance()->setSpanId(spanId);
...
static const JNINativeMethod profiler_natives[] = {
    ...
    F(AsyncProfiler, setContextId0,      "(J)V"),
    F(AsyncProfiler, setTracingContext0, "(JJ)V"),
    F(AsyncProfiler, setTraceId0,        "(JJ)V"),
};
